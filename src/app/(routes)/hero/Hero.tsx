    ...
    <BackgroundImage image="/images/hero.jpg">
      ...
      >
        ...
        <Link to='contacts'
                ...
                spy={true}
                hashSpy={true}
                className="block relative px-[64px] py-[18px] w-[100%] text-[18px] lg:text-[32px] font-bold uppercase leading-none bg-white bg-opacity-10 transition duration-300 hover:bg-opacity-20 text-center">
